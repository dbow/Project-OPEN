...
__version__ = '$Id: wikipedia_family.py 9265 2011-05-20 19:33:10Z xqt $'
...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ro', 'da', 'ar', 'eo', 'sr', 'fa', 'lt', 'sk', 'ms', 'vo', 'he',
            'bg', 'sl', 'war', 'eu', 'hr', 'hi', 'et', 'gl', 'simple', 'new',
            'th', 'nn', 'az', 'el', 'roa-rup', 'la', 'ht', 'tl', 'ka', 'te',
            'mk', 'ceb', 'sh', 'pms', 'nap', 'br', 'be-x-old', 'lv', 'mr', 'jv',
            'lb', 'cy', 'ta', 'sq', 'is', 'bs', 'be', 'oc', 'an', 'bpy', 'bn',
            'io', 'kk', 'sw', 'lmo', 'fy', 'gu', 'ml', 'af', 'nds', 'ur', 'scn',
            'qu', 'ku', 'zh-yue', 'su', 'ast', 'hy', 'ne', 'mg', 'yo',
            'bat-smg', 'cv', 'ga', 'pnb', 'wa', 'kn', 'tg', 'als', 'vec',
            'roa-tara', 'tt', 'zh-min-nan', 'yi', 'bug', 'gd', 'os', 'uz', 'am',
            'sah', 'pam', 'arz', 'mi', 'li', 'hsb', 'nah', 'sco', 'mn', 'co',
            'gan', 'glk', 'my', 'ia', 'bcl', 'fo', 'sa', 'fiu-vro', 'si',
            'nds-nl', 'vls', 'tk', 'bar', 'ckb', 'gv', 'ilo', 'map-bms', 'dv',
            'nrm', 'mrj', 'pag', 'rm', 'diq', 'se', 'mzn', 'wuu', 'fur', 'ug',
            'bo', 'lij', 'mt', 'hif', 'csb', 'bh', 'km', 'ang', 'nov', 'lad',
            'udm', 'zh-classical', 'sc', 'cbk-zam', 'pi', 'mhr', 'ps', 'ksh',
            'frp', 'kv', 'hak', 'rue', 'kw', 'nv', 'pa', 'szl', 'so', 'xal',
            'rw', 'ie', 'haw', 'stq', 'pdc', 'ln', 'krc', 'to', 'pcd', 'crh',
            'ace', 'ky', 'ext', 'myv', 'gn', 'koi', 'ba', 'eml', 'ce', 'arc',
            'pap', 'ay', 'kl', 'bjn', 'frr', 'jbo', 'wo', 'tpi', 'kab', 'ty',
            'srn', 'zea', 'or', 'gag', 'dsb', 'ab', 'lo', 'ig', 'mdf', 'tet',
            'av', 'kg', 'mwl', 'rmy', 'lbe', 'ltg', 'cu', 'kaa', 'kbd', 'sm',
            'got', 'pfl', 'bm', 'na', 'ks', 'as', 'ik', 'sd', 'bi', 'iu', 'ss',
            'pih', 'pnt', 'cdo', 'chr', 'ee', 'ha', 'ti', 'zu', 'bxr', 'om',
            'za', 've', 'ts', 'rn', 'sg', 'dz', 'tum', 'cr', 'ch', 'lg', 'fj',
            'ny', 'st', 'xh', 'ff', 'tn', 'ki', 'sn', 'chy', 'ak', 'tw',
        ]
